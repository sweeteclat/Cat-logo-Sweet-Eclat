const products = {
  chocolateria: [
    ...
    },
    {
      ...
      description: "Fresas seleccionadas, sumergidas en chocolate y preparadas para convertir cualquier ocasión en un detalle especial.",
      image: "fresas.png",
      details: [
        "Decoradas con grageas y/o frutos secos.",
        "Cajas de regalo de 6, 12 y 24 unidades.",
        "Ideales para aniversario, San Valentín, cumpleaños y recordatorios."
      ]
    },
    {
      id: "chocobombas",
      name: "Chocobombas",
      description: "Cacao de alta calidad (relleno de café, Milo y malvaviscos), pensado para una experiencia dulce y reconfortante.",
      image: "chocobombas.png",
      details: [
        "Elaboradas con cacao de alta calidad y relleno de café, Milo y malvaviscos.",
